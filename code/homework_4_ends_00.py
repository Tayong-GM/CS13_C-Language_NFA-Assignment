...
# accepts binary strings ending in "00"
# ---------------------------------------------------------------------
...
transitions = {
    'r0': {'0': 'r1', '1': 'r0'},
    'r1': {'0': 'r2', '1': 'r3'},
    'r2': {'0': 'r2', '1': 'r3'},   # final: last two chars were "00"
    'r3': {'0': 'r4', '1': 'r0'},   # redundant: behaves just like r0
    'r4': {'0': 'r2', '1': 'r3'},   # redundant: behaves just like r1
}
start = 'r0'
finals = {'r2'}
